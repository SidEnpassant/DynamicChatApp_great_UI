...
//               if (mounted) {
//                 // Pop twice to exit info screen and chat screen
...
//     final bool isAdmin = widget.group.admins.contains(_auth.currentUser!.uid);
...
//                       // () {
//                       //   // TODO: Implement change group icon
//                       // },
//                     ),
//                   ),
//                 ),
...
//   Widget _buildExitGroupButton(BuildContext context) {
//     return Padding(
//       padding: const EdgeInsets.all(20.0),
//       child: ListTile(
//         leading: const Icon(Icons.exit_to_app, color: Colors.red),
//         title: const Text('Exit Group', style: TextStyle(color: Colors.red)),
//         onTap: () => _handleExitGroup(context, updatedGroup),
//       ),
//     );
//   }
// }
  ...
  Widget _buildExitGroupButton(BuildContext context, GroupProfile group) {
    return Padding(
      ...
      child: ListTile(
        ...
        // => _handleExitGroup(context, group),
      ),
    );
  }
}
